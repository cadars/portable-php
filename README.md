...
- [ParsedownExtraPlugin](https://github.com/taufik-nurrohman/parsedown-extra-plugin) i used to add the `loading="lazy"` attribute to images, figure and figcaption elements, and more. Could be used for [code highlighting](https://github.com/taufik-nurrohman/parsedown-extra-plugin#custom-code-block-contents).
